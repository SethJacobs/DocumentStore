...
public class MinHeapImpl<E extends Comparable> extends MinHeap<E> {
    ...
    protected void doubleArraySize() {
        E[] temp;
        temp= (E[]) new Comparable[this.count*2];
    ...
    protected  void swap(int i, int j)
    {
        ...
        elementsToArrayIndex.put(elements[i], elementsToArrayIndex.get(elements[j]));
        elementsToArrayIndex.put(elements[j], elementsToArrayIndex.get(elements[i]));
